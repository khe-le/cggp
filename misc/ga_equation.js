...
// ----- USER INPUT -----
const u_infixFormula = 'x+y-z'; // Desired INFIX math formula
const u_vars = ['x','y','z']; // Number of variables used

// User-provided test case(s)
const u_tests =  [{x:1, y:5, z:6}, {x: 3, y:7, z:15}, 
                  {x:5, y:6, z:1}, {x:9, y:20, z:89}, 
                  {x:10, y:40, z:60}]
